    ...
    <footer className="mt-10 mb-20 border-t border-accent-2">
      <Container>
        <div className="pb-16 pt-8 lg:py-16 flex flex-col ">
          ...
          className="fill-accent-4 hover:fill-accent-4/75
           flex gap-1 items-center
           text-accent-4 hover:underline hover:text-accent-4/75 transition-all w-fit lg:m-4 p-4 text-md lg:text-lg tracking-tighter leading-tight lg:text-left mb-6 lg:mb-0 lg:pr-4 ">
            GitHub
