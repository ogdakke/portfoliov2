    ...
    <div className="z-50 flex justify-center w-full fixed bottom-6 h-min px-3">
      <nav className="border border-accent-3/10 flex flex-row justify-between w-full relative p-5 bg-accent-4/50 dark:bg-accent-1/40 backdrop-blur-xl max-w-3xl rounded-3xl">
        <div className="fill-accent-5/90 dark:fill-accent-3 text-accent-5 dark:text-accent-3 flex flex-row gap-6">
          ...
          >
            <svg
              aria-label="logo of home button"
              width="18"
              height="18"
              viewBox="0 0 20 20"
              fill="inherit"
          ...
          >
            <svg
              fill="inherit"
              aria-label="logo of blog button"
              width="18"
              height="18"
              viewBox="0 -1 20 20"
              xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="flex justify-self-end">
          ...
          >
            ...
            >
              <path
                d="M15 1V2.55556M15 27.4444V29M29 15H27.4444M2.55556 15H1M24.8995 24.8995L23.7996 23.7996M6.20045 6.20045L5.1005 5.1005M24.8996 5.10059L23.7996 6.20053M6.20053 23.7996L5.10059 24.8996M21.2222 15C21.2222 18.4364 18.4364 21.2222 15 21.2222C11.5636 21.2222 8.77778 18.4364 8.77778 15C8.77778 11.5636 11.5636 8.77778 15 8.77778C18.4364 8.77778 21.2222 11.5636 21.2222 15Z"
                stroke="inherit"
                strokeWidth="inherit"
                strokeLinecap="round"
